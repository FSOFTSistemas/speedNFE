                ...
                <header>
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            ...
                            <input type="text" class="form-control" name="natOp" wire:model="ide.natOp" readonly
                                required>
                        </div>
                        <div class="col-md-5 mb-3">
                            <label class="form-label">Data de Emissão</label>
                            <input type="text" class="form-control" name="dhEmi"
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="chNFe" name="chNFe" wire:model="chNFe"
                                readonly required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="vNF" class="form-label">Valor Total da Nota</label>
                            <input type="text" class="form-control" id="vNF" name="vNF" wire:model="vNF"
                                readonly required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            ...
                            <input type="text" class="form-control" name="fornecedor" wire:model="emit.xNome"
                                readonly required>
                        </div>
                        <div class="col-md-5 mb-3">
                            <label class="form-label">CNPJ</label>
                            <input type="text" class="form-control" name="CNPJ" wire:model="emit.CNPJ" readonly
                                required>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="dhSaiEnt"
                        value="{{ date('d/m/Y H:i:s', strtotime($ide['dhSaiEnt'] ?? now())) }}">
                </header>
                            ...
                            @foreach ($prods as $index => $item)
                                <div class="card mb-2" wire:ignore.self>
                                    <div class="card-header" id="heading{{ $index }}">
                                        <h2 class="mb-0">
                                            <button
                                                ...
                                                data-target="#collapse{{ $item[0]['cProd'] . $index }}"
                                                ...
                                                <i class="fas fa-chevron-down ml-2"><small
                                                        class="text-muted ml-2">(clique para expandir)</small></i>
                                            </button>
                                        </h2>
                                    </div>
                                    ...
                                    <div id="collapse{{ $item[0]['cProd'] . $index }}"
                                        ...
                                        aria-labelledby="heading{{ $index }}" data-parent="#accordionProducts"
                                        wire:ignore.self>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-8 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div wire:ignore>
                                                        <select class="form-control select2-basic"
                                                            id="categoria_{{ $index }}"
                                                            name="prods[{{ $index }}][0][categoria]" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        wire:model="prods.{{ $index }}.0.cEAN" required>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label class="form-label">Unidade</label>
                                                    <input type="text" class="form-control"
                                                        name="prods[{{ $index }}][0][uCom]"
                                                        wire:model="prods.{{ $index }}.0.uCom" required>
                                                </div>
                                                <div class="col-md-3 mb-3">
