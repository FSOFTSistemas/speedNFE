            ...
            <form class="needs-validation mt-4" novalidate method="POST" action="{{ route('update_produto', ['id' => $produto->id]) }}">
                ...
                <div class="tab-content" id="tabContent">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        {{-- BLOCO 1: TRIBUTAÇÃO ANTIGA --}}
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="cfopinterno" class="form-label">CFOP Interno</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="cfopexterno" class="form-label">CFOP Externo</label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select select2-basic" name="cst" id="cst" required>
                                    ...
                                    <option value="30" @if ($produto->cst == '30') selected @endif>30 - Tributação simplificada</option>
                                    <option value="40" @if ($produto->cst == '40') selected @endif>40 - Tributação simplificada com acréscimo de ST</option>
                                    <option value="41" @if ($produto->cst == '41') selected @endif>41 - Tributação com ICMS e acréscimo de ST por Subst. Tributária</option>
                                    <option value="50" @if ($produto->cst == '50') selected @endif>50 - Tributação com ICMS e acréscimo de ST com direito a crédito</option>
                                    <option value="51" @if ($produto->cst == '51') selected @endif>51 - Tributação com ICMS e acréscimo de ST sem direito a crédito</option>
                                    <option value="60" @if ($produto->cst == '60') selected @endif>60 - Tributação com ICMS e acréscimo de ST com acréscimo</option>
                                    <option value="70" @if ($produto->cst == '70') selected @endif>70 - Redução de base de cálculo</option>
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <select class="form-select select2-basic" name="cst_csosn" id="cst_csosn" required>
                                    ...
                                    <option value="103" @if ($produto->cst_csosn == '103') selected @endif>103 - Isenção do ICMS no Simples Nacional</option>
                                    <option value="201" @if ($produto->cst_csosn == '201') selected @endif>201 - Tributada pelo Simples Nacional com permissão de crédito e ST</option>
                                    <option value="202" @if ($produto->cst_csosn == '202') selected @endif>202 - Tributada pelo Simples Nacional sem permissão de crédito e ST</option>
                                    <option value="203" @if ($produto->cst_csosn == '203') selected @endif>203 - Isenção do ICMS no Simples Nacional e ST</option>
                                    ...
                                    <option value="500" @if ($produto->cst_csosn == '500') selected @endif>500 - ICMS cobrado anteriormente por ST</option>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select select2-basic" name="cst_pis" id="cst_pis" required>
                                    <option value="" disabled selected>Selecione...</option>
                                    <option value="1" @if ($produto->cst_pis == '1') selected @endif>01 - Operação Tributável com Alíquota Básica</option>
                        ...
                        <div class="row">
                             <div class="col-12 mb-3">
                                ...
                                <select class="form-select select2-basic" name="cst_cofins" id="cst_cofins" required>
                                     <option value="" disabled selected>Selecione...</option>
                                     <option value="1" @if ($produto->cst_cofins == '1') selected @endif>01 - Operação Tributável com Alíquota Básica</option>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control" type="number" name="icms" id="icms" value="{{ $produto->icms }}" required>
                            </div>
                            <div class="col-md-3 mb-3">
                        ...
                        {{-- BLOCO 2: REFORMA TRIBUTÁRIA (IBS/CBS) - NOVO --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select select2-basic" name="cst_ibs_cbs" id="cst_ibs_cbs" onchange="limparCClass()">
                                    ...
                                    @if(isset($csts))
                                        @foreach ($csts as $cst)
                                            <option value="{{ $cst->codigo }}" @if ($produto->cst_ibs_cbs == $cst->codigo) selected @endif>
                                                {{ $cst->codigo }} - {{ Str::limit($cst->descricao, 80) }}
                                            </option>
                                        @endforeach
                                    @else
                                        <option value="010" @if ($produto->cst_ibs_cbs == '010') selected @endif>010 - Tributação Normal</option>
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="cClassTrib" id="cClassTrib" 
                                           value="{{ $produto->cClassTrib }}" placeholder="Selecione um CST primeiro..." required readonly>
                                    <div class="input-group-append">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="number" step="0.01" name="pIBS" id="pIBS" 
                                       value="{{ $produto->pIBS }}" placeholder="Ex: 12.00">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="pCBS" class="form-label">Alíquota CBS (%)</label>
                                <input class="form-control" type="number" step="0.01" name="pCBS" id="pCBS" 
                                       value="{{ $produto->pCBS }}" placeholder="Ex: 8.00">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="pIS_imposto" class="form-label">Alíq. Imposto Seletivo (%)</label>
                                <input class="form-control" type="number" step="0.01" name="pIS_imposto" id="pIS_imposto" 
                                       value="{{ $produto->pIS_imposto }}" placeholder="Se houver incidência">
                            </div>
                        </div>
                    </div>
