                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-5">
                                            ...
                                            <select class="form-control" name="combVeic" id="combVeic">
                                                <option value="1"
                                                    @if (old('combVeic') == '1') selected @endif>ÁLCOOL</option>
                                                <option value="2"
                                                    @if (old('combVeic') == '2') selected @endif>GASOLINA</option>
                                                <option value="3"
                                                    @if (old('combVeic') == '3') selected @endif>DIESEL</option>
                                                <option value="16"
                                                    @if (old('combVeic') == '16') selected @endif>ÁLCOOL/GASOLINA
                                                </option>
                                                <option value="17"
                                                    @if (old('combVeic') == '17') selected @endif>
                                                    GASOLINA/ÁLCOOL/GNV</option>
                                                <option value="18"
                                                    @if (old('combVeic') == '18') selected @endif>GASOLINA/ELÉTRICO
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-7">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="cm3Veic"
                                                name="cm3Veic" value="{{ old('cm3Veic') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="corVeic" name="corVeic"
                                                oninput="this.value = this.value.toUpperCase()"
                                                value="{{ old('corVeic') }}" placeholder="Cor...">
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="espVeic" id="espVeic">
                                                <option value="1"
                                                    @if (old('espVeic') == '1') selected @endif>PASSAGEIRO
                                                </option>
                                                <option value="2"
                                                    @if (old('espVeic') == '2') selected @endif>CARGA</option>
                                                <option value="3"
                                                    @if (old('espVeic') == '3') selected @endif>MISTO</option>
                                                <option value="4"
                                                    @if (old('espVeic') == '4') selected @endif>CORRIDA</option>
                                                <option value="5"
                                                    @if (old('espVeic') == '5') selected @endif>TRAÇÃO</option>
                                                <option value="6"
                                                    @if (old('espVeic') == '6') selected @endif>ESPECIAL</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" name="vinVeic" id="vinVeic">
                                                <option value="N"
                                                    @if (old('vinVeic') == 'N') selected @endif>NORMAL</option>
                                                <option value="R"
                                                    @if (old('vinVeic') == 'R') selected @endif>REMARCADO</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-5">
                                            ...
                                            <select class="form-control" name="restriVeic" id="restriVeic">
                                                <option value="0"
                                                    @if (old('restriVeic') == '0') selected @endif>NÃO HÁ</option>
                                                <option value="1"
                                                    @if (old('restriVeic') == '1') selected @endif>ALIENAÇÃO
                                                    FIDUNCIÁRIA</option>
                                                <option value="2"
                                                    @if (old('restriVeic') == '2') selected @endif>ARRENDAMENTO
                                                    MERCANTIL</option>
                                                <option value="3"
                                                    @if (old('restriVeic') == '3') selected @endif>RESERVA DE DOMÍNIO
                                                </option>
                                                <option value="4"
                                                    @if (old('restriVeic') == '4') selected @endif>PENHOR DE VEÍCULOS
                                                </option>
                                                <option value="9"
                                                    @if (old('restriVeic') == '9') selected @endif>OUTRAS</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <select class="form-control" name="operVeic" id="operVeic">
                                                <option value="1"
                                                    @if (old('operVeic') == '1') selected @endif>VENDA
                                                    CONCERSSIONÁRIA</option>
                                                <option value="2"
                                                    @if (old('operVeic') == '2') selected @endif>FATURAMENTO DIRETO
                                                    PARA CONSUMIDOR FINAL</option>
                                                <option value="3"
                                                    @if (old('operVeic') == '3') selected @endif>VENDA DIRETO PARA
                                                    GRANDES CONSUMIDORES</option>
                                                <option value="0"
                                                    @if (old('operVeic') == '0') selected @endif>OUTRAS</option>
                                            </select>
                                        </div>
                                    </div>
