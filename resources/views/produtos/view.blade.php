...
@section('content_header')
    <div class="row text-center">
        <div class="col">
            <h3 class="m-0">Visualização de Produto</h3>
        </div>
    </div>
@stop
                                        ...
                                        <div class="input-group has-validation mb-2">
                                            <div class="form-floating">
                                                <input class="form-control" type="text" name="ncm" id="ncm"
                                                    value="{{ $produto->ncm }}" required placeholder=" ">
                                            ...
                                            <div class="form-floating">
                                                <select class="form-select" name="cfopinterno" id="cfopinterno" required>
                                                    @foreach ($cfops as $cfop)
                                                        @if ($produto->cfop_interno == $cfop->cfop)
                                        ...
                                        <div class="input-group has-validation mb-2">
                                            <div class="form-floating">
                                                <select class="form-select" name="cfopexterno" id="cfopexterno" required>
                                                    @foreach ($cfops as $cfop)
                                                        @if ($produto->cfop_externo == $cfop->cfop)
                                                            <option value="{{ $cfop->cfop }}">
                                                                {{ $cfop->cfop }} -
                                                                {{ $cfop->natureza }}</option>
                                                        @endif
                                        ...
                                        <div class="input-group has-validation mb-2">
                                            <div class="form-floating">
                                                <input class="form-control" type="number" name="icms" id="icms"
                                                    step="0.01" value="{{ $produto->icms }}" required
                                                    placeholder=" ">
                                        ...
                                        <div class="input-group has-validation mb-2">
                                            <div class="form-floating">
                                                <input class="form-control" type="text" name="pis" id="pis"
                                                    value="{{ $produto->pis }}" required placeholder=" ">
                                        ...
                                        <div class="input-group has-validation mb-2">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="ipi" id="ipi"
                                                    value="{{ $produto->ipi }}" required placeholder=" ">
                                ...
                                @if ($produto->tpProd)
                                    <div class="row">
                                        <div class="col-md-4 col-12">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="tpVeic" id="tpVeic" required>
                                                        <option value="02"
                                            ...
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="anoFabVeic" required
                                                        ...
                                                        value="{{ $produto->anoFabVeic }}" placeholder=" ">
                                            ...
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="anoModVeic" required
                                                        ...
                                                        value="{{ $produto->anoModVeic }}" placeholder=" ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-12">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="combVeic" id="combVeic" required>
                                                        <option value="1"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="tpPVeic" required
                                                        name="tpPVeic" value="{{ $produto->tpPVeic }}" placeholder=" ">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="cCorVeic" id="cCorVeic" required>
                                                        <option value="01"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="condVeic" id="condVeic" required>
                                                        <option value="1"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="espVeic" id="espVeic" required>
                                                        <option value="1"
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="vinVeic" id="vinVeic" required>
                                                        <option value="N"
                                            ...
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="lotVeic" required
                                                        name="lotVeic" value="{{ $produto->lotVeic }}" placeholder=" ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group has-validation mb-2">
                                                <div class="form-floating">
                                                    <select class="form-select" name="operVeic" id="operVeic" required>
                                                        <option value="1"
