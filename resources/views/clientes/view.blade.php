...
@section('content_header')
    <div class="row" style="text-align: center">
        <div class="col">
            <h5 class="m-0 text-dark">Visualizar Cliente</h5>
        </div>
    </div>
@stop
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="col-md-6 col-xs-10">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="cpf_cnpj" id="cpf_cnpj"
                                                onblur="this.value = formatarCpfCnpj(this.value);" required
                                                placeholder="CPF/CNPJ..." maxlength="14"
                                                value="{{ $cliente->cpf_cnpj }}">
                                            <div class="input-group-append">
                                                <button id="cnpj_button" type="button"
                                                    class="btn btn-light"><i class="fa fa-search"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-10">
                                        ...
                                        <input class="form-control" type="text" name="limite" id="limite" required
                                            placeholder="Limite..." value="{{ $cliente->limite }}">
                                    </div>
                                    <div class="col-md-6 col-xs-10">
                                        <label for="rg_ie">RG ou IE</label>
                                        <input class="form-control" type="text" name="rg_ie" id="rg_ie" required
                                            placeholder="RG/IE..." value="{{ $cliente->rg_ie }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-10">
                                        ...
                                        <input class="form-control" type="text" name="codigo" id="codigo" required
                                            placeholder="Código gerencial..." value="{{ $cliente->codigo }}" value="0"
                                            hidden>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="cep" placeholder="Cep..." id="cep" value="{{ $cliente->cep }}" required>
                                            <div class="input-group-append">
