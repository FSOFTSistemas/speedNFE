...
@push('css')
    <style>
        ...
        @keyframes pulse {
            0% {
                box-shadow: 0 0 0 0 rgba(0, 3, 58, 0.7);
            }

            70% {
                box-shadow: 0 0 0 10px rgba(0, 3, 58, 0);
            }

            100% {
                box-shadow: 0 0 0 0 rgba(0, 3, 58, 0);
            }
        }
...
@section('content')
    <div class="alert alert-secondary">
        ...
        <p>Para o campo de <b>Inscrição Estadual</b>, preencha da seguinte forma, se o cliente for <b>Pessoa Jurídica</b>:
        </p>
        <ul>
            <li style="color: gold">
                <b><i>É CONTRIBUINTE: </i></b> Se o cliente possui Inscrição Estadual, digite o <b
                    style="color: white">número da inscrição</b>.
            </li>
            <li style="color: gold">
                <b><i>É CONTRIBUINTE ISENTO: </i> </b> Se o cliente é contribuinte, mas isento de inscrição, digite <b
                    style="color: white">ISENTO</b>.
            </li>
            <li style="color: gold">
                <b><i>NÃO É CONTRIBUINTE: </i></b> Se o cliente é consumidor final (pessoa física ou jurídica que não
                revende a
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="tipo" id="tipo" required>
                                    ...
                                    <option value="1" @if (old('tipo') == '1') selected @endif>Pessoa Física
                                    </option>
                                </select>
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="cpf_cnpj" name="cpf_cnpj"
                                        placeholder="Digite o CPF ou CNPJ" required value="{{ old('cpf_cnpj') }}">
                                    <div class="input-group-append">
                                        <button id="cnpj_button" type="button" class="btn btn-dark"
                                            style="border-radius: 0 8px 8px 0;"><i class="fa fa-search"></i></button>
                                    </div>
                                    <div class="invalid-feedback">Informe um CPF/CNPJ válido.</div>
                                </div>
                                <div id="cpfCnpjFeedback" class="text-danger small mt-1" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-7 mb-3">
                                ...
                                <input class="form-control" type="text" name="nome" id="nome"
                                    placeholder="Nome completo ou Razão Social" value="{{ old('nome') }}" required>
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input class="form-control" type="text" name="apelido" id="apelido"
                                    placeholder="Apelido ou Nome Fantasia" value="{{ old('apelido') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="text" name="rg_ie" id="rg_ie"
                                    placeholder="Inscrição Estadual" value="{{ old('rg_ie') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="telefone" name="telefone" class="form-control"
                                    placeholder="Telefone com DDD" maxlength="15" onkeyup="handlePhone(event)"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="text" name="limite" id="limite"
                                    placeholder="0,00" value="{{ old('limite') ?? 0 }}" required>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input placeholder="Digite o CEP" class="form-control" type="text" id="cep"
                                        name="cep" value="{{ old('cep') }}" />
                                    <div class="input-group-append">
                                        <button class="btn btn-dark" type="button" id="cep_button"
                                            style="border-radius: 0 8px 8px 0;"><i class="fa fa-search"></i></button>
                                    </div>
                                    <div class="invalid-feedback">Informe um CEP válido.</div>
                                </div>
                                <div id="cep-guidance" class="form-text text-primary font-weight-bold mt-2"
                                    style="display: none;">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input class="form-control" type="text" name="rua" id="rua"
                                    value="{{ old('rua') }}" placeholder="Rua, Avenida, etc.">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input placeholder="Código IBGE" class="form-control" type="number" id="ibge"
                                    name="ibge" value="{{ old('ibge') }}" />
                                <div class="invalid-feedback">Informe um código IBGE válido.</div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-md-6 mx-auto text-center">
                                <button type="submit" class="btn custom-btn-primary btn-block" id="btn-salvar"
                                    disabled>Salvar Cliente</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const feedbackDiv = document.getElementById('cpfCnpjFeedback');
            const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');

            // Função auxiliar para desabilitar botões
            function setButtonsDisabled(disabled) {
                proximoButton.disabled = disabled;
                
                if (disabled) {
                    salvarButton.disabled = true; // Se o CPF for duplicado, desabilite o 'salvar'
                } else {
                    // Se não for duplicado, volte a respeitar a regra do CEP
            ...
            cpfCnpjInput.addEventListener('blur', function() {
                const cpfCnpjValue = this.value;
                const cpfCnpjLimpo = somenteNumeros(cpfCnpjValue); // Reutiliza sua função

                // Não faz a verificação se o campo for muito curto
                ...
                // Mostra um "carregando" (opcional, mas bom)
                feedbackDiv.style.display = 'block';
                feedbackDiv.classList.remove('text-danger');
                feedbackDiv.classList.add('text-muted');
                feedbackDiv.innerText = 'Verificando...';

                fetch('/clientes/check-cpf', { // Rota que criamos
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.exists) {
                        feedbackDiv.innerText = 'Este CPF/CNPJ já está cadastrado.';
                        feedbackDiv.classList.add('text-danger');
                        feedbackDiv.classList.remove('text-muted');
                        setButtonsDisabled(true); // Desabilita botões
                    } else {
                        feedbackDiv.style.display = 'none'; // Esconde mensagem
                        setButtonsDisabled(false); // Reabilita botões
                    }
                })
                .catch(error => {
                    console.error('Erro ao verificar CPF/CNPJ:', error);
                    feedbackDiv.style.display = 'none';
                    setButtonsDisabled(false); // Em caso de erro, habilita os botões
                });
            });
            ...
            $('a[data-toggle="pill"]').on('shown.bs.tab', function(e) {
                if (e.target.id === 'profile-tab' && cepInput.value.trim() !== '' && salvarButton
                    .disabled) {
            ...
            if (cpfCnpjInput) {
                cpfCnpjInput.addEventListener('input', (e) => {
                    ...
                    if (value.length > 11) {
                        value = value.substring(0, 14).replace(/^(\d{2})(\d)/, '$1.$2').replace(
                                /^(\d{2})\.(\d{3})(\d)/, '$1.$2.$3').replace(/\.(\d{3})(\d)/, '.$1/$2')
                            .replace(/(\d{4})(\d{1,2})$/, '$1-$2');
                    } else {
                        value = value.substring(0, 11).replace(/(\d{3})(\d)/, '$1.$2').replace(
                            /(\d{3})(\d)/, '$1.$2').replace(/(\d{3})(\d{1,2})$/, '$1-$2');
                    }
