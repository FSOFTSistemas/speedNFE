...
@section('content_header')
    <h1 class="m-0 text-dark">Emitir CTe</h1>
@stop

@section('content')
<div class="card card-main">
    <div class="card-body">
        <form action="{{ route('cte.store') }}" method="POST">
            @csrf
            @include('ctes._form', ['clientes' => $clientes, 'veiculos' => $veiculos, 'motoristas' => $motoristas])
